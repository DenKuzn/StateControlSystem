...
/**	Actions in States.
	...
	This component added only once to one player (pawn, controller, etc) and stores all states in the game for this player.
	Stored only on Clients because it represent what player selected and with what player interacted. All orders, other data etc are not related with ControlState despite
	that SCS create this orders or activate it.
*/

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent), Blueprintable, BlueprintType )
class STATECONTROLSYSTEM_API UStateControlSystemComponent : public UActorComponent
{
	GENERATED_BODY()
